...
module SwaggerClient
  ...
  class InlineResponse20019Transaction
    attr_accessor :fee
    ...
    def self.swagger_types
      {
        :'fee' => :'Integer',
        :'inner_hash' => :'String',
        :'inputs' => :'InlineResponse2003BodyInputs',
        :'length' => :'Integer',
        :'outputs' => :'InlineResponse2003BodyOutputs',
        :'sigs' => :'Array<String>',
        :'txid' => :'String',
        :'type' => :'Integer'
      }
    ...
    def hash
      [fee, inner_hash, inputs, length, outputs, sigs, txid, type].hash
    end
