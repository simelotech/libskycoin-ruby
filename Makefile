...
build-swig:
	...
	rm -f ./skycoin/skycoin.r
	rm -f swig/skycoinruby_wrap.c
	swig -ruby -Iswig/include -I$(INCLUDE_DIR) -outdir ./skycoin/ -o swig/skycoinruby_wrap.c $(LIBSWIG_DIR)/skycoin.i

develop:
	$(RUBY_BIN) setup.r develop
